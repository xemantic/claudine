...
val claudineSystemPrompt = """
  ...
  When requesting to cache certain tool result, don't exceed the limit of 4 elements
  to be cached in the token window.

  When executingShellCommand for listing files, try to minimize the amount of executions in favor of
